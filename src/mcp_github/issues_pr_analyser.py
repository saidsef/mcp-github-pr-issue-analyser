...
be called without listing first. Call github_list_skills for the set, and
github_get_skill to read one, which needs nothing but tool support. The same content is served as MCP resources under the
