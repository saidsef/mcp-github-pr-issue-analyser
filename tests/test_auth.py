"""Tests for auth.py - credential verification and token resolution, Redis client
construction, token store selection, and the DynamoDB table ARN and startup setup."""
